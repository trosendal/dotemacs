...
s0_edge_responsiveness = 2,054545
...
[core]
s0_active_plugins = core;composite;opengl;mousepoll;wall;regex;imgpng;copytex;put;vpswitch;unitymtgrabhandles;grid;compiztoolbox;animation;place;resize;expo;ezoom;move;commands;session;workarounds;fade;scale;unityshell;
...
s0_put_next_output_key = <Control><Alt>Prior
s0_put_next_output_button = Disabled
s0_put_previous_output_key = <Control><Alt>Next
